...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get settings_sendAdvertisementSubtitle => 'Отправить оповещение о присутствии сейчас';
...
'Ноды должны передавать свои GPS-координаты,
чтобы отображаться на карте';
...
'Скрывать имя/местоположение в оповещениях';
  ...
  @override
  String get repeater_advertisementSettings => 'Настройки оповещений';
  
  @override
  String get repeater_localAdvertInterval => 'Интервал локальных оповещений';
  ...
  @override
  String get repeater_floodAdvertInterval => 'Интервал оповещений рассылкой';
...
'Интервал зашифрованных оповещений';
...
'Введите команду ниже или используйте быстрые команды';
  ...
  @override
  String get repeater_cliQuickAdvertise => 'Оповестить';
  
  @override
  String get repeater_cliQuickClock => 'Время';
  
  @override
  String get repeater_cliHelpAdvert => 'Отправляет пакет оповещения';
...
'Устанавливает интервал (в минутах) отправки локального (нулевой хоп) оповещения. Установите 0, чтобы отключить.';
  
  @override
  String get repeater_cliHelpSetFloodAdvertInterval =>
'Устанавливает интервал (в часах) отправки оповещения рассылкой. Установите 0, чтобы отключить.';
...
'Показывает конфигурацию передачи местоположения в оповещениях:
